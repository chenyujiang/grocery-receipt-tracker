...
//    client) to OCR the receipt and translate English -> Chinese in one call.
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // TODO: call the Claude API server-side (CLAUDE_API_KEY from env, never sent to the client).
